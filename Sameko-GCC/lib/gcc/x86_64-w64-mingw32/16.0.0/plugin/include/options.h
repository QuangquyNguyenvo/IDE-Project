...
#define OPTION_MASK_ISA2_AVX512FP16 (HOST_WIDE_INT_1U << 13)
...
#define OPTION_MASK_ISA2_AVX512VP2INTERSECT (HOST_WIDE_INT_1U << 14)
#define OPTION_MASK_ISA_AVX512VPOPCNTDQ (HOST_WIDE_INT_1U << 20)
#define OPTION_MASK_ISA2_AVXIFMA (HOST_WIDE_INT_1U << 15)
#define OPTION_MASK_ISA2_AVXNECONVERT (HOST_WIDE_INT_1U << 16)
#define OPTION_MASK_ISA2_AVXVNNI (HOST_WIDE_INT_1U << 17)
#define OPTION_MASK_ISA2_AVXVNNIINT16 (HOST_WIDE_INT_1U << 18)
#define OPTION_MASK_ISA2_AVXVNNIINT8 (HOST_WIDE_INT_1U << 19)
...
#define OPTION_MASK_ISA2_CLDEMOTE (HOST_WIDE_INT_1U << 20)
#define OPTION_MASK_ISA_CLFLUSHOPT (HOST_WIDE_INT_1U << 23)
#define OPTION_MASK_ISA_CLWB (HOST_WIDE_INT_1U << 24)
#define OPTION_MASK_ISA2_CLZERO (HOST_WIDE_INT_1U << 21)
#define OPTION_MASK_ISA2_CMPCCXADD (HOST_WIDE_INT_1U << 22)
#define OPTION_MASK_ISA_CRC32 (HOST_WIDE_INT_1U << 25)
#define OPTION_MASK_ISA2_CX16 (HOST_WIDE_INT_1U << 23)
#define OPTION_MASK_ISA2_ENQCMD (HOST_WIDE_INT_1U << 24)
...
#define OPTION_MASK_ISA2_HLE (HOST_WIDE_INT_1U << 25)
#define OPTION_MASK_ISA2_HRESET (HOST_WIDE_INT_1U << 26)
...
#define OPTION_MASK_ISA2_KL (HOST_WIDE_INT_1U << 27)
...
#define OPTION_MASK_ISA2_MOVBE (HOST_WIDE_INT_1U << 28)
#define OPTION_MASK_ISA2_MOVDIR64B (HOST_WIDE_INT_1U << 29)
#define OPTION_MASK_ISA_MOVDIRI (HOST_WIDE_INT_1U << 35)
#define OPTION_MASK_ISA2_MOVRS (HOST_WIDE_INT_1U << 30)
#define MASK_MS_BITFIELD_LAYOUT (1U << 18)
#define OPTION_MASK_ISA2_MWAIT (HOST_WIDE_INT_1U << 31)
#define OPTION_MASK_ISA2_MWAITX (HOST_WIDE_INT_1U << 32)
...
#define OPTION_MASK_ISA2_PCONFIG (HOST_WIDE_INT_1U << 33)
#define OPTION_MASK_ISA_PKU (HOST_WIDE_INT_1U << 37)
#define OPTION_MASK_ISA_POPCNT (HOST_WIDE_INT_1U << 38)
#define OPTION_MASK_ISA2_PREFETCHI (HOST_WIDE_INT_1U << 34)
#define OPTION_MASK_ISA_PRFCHW (HOST_WIDE_INT_1U << 39)
#define OPTION_MASK_ISA2_PTWRITE (HOST_WIDE_INT_1U << 35)
#define OPTION_MASK_ISA2_RAOINT (HOST_WIDE_INT_1U << 36)
#define OPTION_MASK_ISA2_RDPID (HOST_WIDE_INT_1U << 37)
...
#define OPTION_MASK_ISA2_SERIALIZE (HOST_WIDE_INT_1U << 38)
#define OPTION_MASK_ISA2_SGX (HOST_WIDE_INT_1U << 39)
#define OPTION_MASK_ISA_SHA (HOST_WIDE_INT_1U << 44)
#define OPTION_MASK_ISA2_SHA512 (HOST_WIDE_INT_1U << 40)
#define OPTION_MASK_ISA_SHSTK (HOST_WIDE_INT_1U << 45)
#define OPTION_MASK_ISA2_SM3 (HOST_WIDE_INT_1U << 41)
#define OPTION_MASK_ISA2_SM4 (HOST_WIDE_INT_1U << 42)
...
#define OPTION_MASK_ISA2_TSXLDTRK (HOST_WIDE_INT_1U << 43)
#define OPTION_MASK_ISA2_UINTR (HOST_WIDE_INT_1U << 44)
#define OPTION_MASK_ISA2_USER_MSR (HOST_WIDE_INT_1U << 45)
#define OPTION_MASK_ISA2_VAES (HOST_WIDE_INT_1U << 46)
#define MASK_VECT8_RETURNS (1U << 29)
#define OPTION_MASK_ISA_VPCLMULQDQ (HOST_WIDE_INT_1U << 54)
#define MASK_VZEROUPPER (1U << 30)
#define OPTION_MASK_ISA2_WAITPKG (HOST_WIDE_INT_1U << 47)
#define OPTION_MASK_ISA2_WBNOINVD (HOST_WIDE_INT_1U << 48)
#define OPTION_MASK_ISA2_WIDEKL (HOST_WIDE_INT_1U << 49)
...
#endif
#if defined(HOST_BITS_PER_WIDE_INT) && 50 > HOST_BITS_PER_WIDE_INT
...
enum opt_code
{
  ...
  OPT__param_auto_profile_bbs_ = 89,         /* --param=auto-profile-bbs= */
  ...
  OPT__param_cycle_accurate_model_ = 98,     /* --param=cycle-accurate-model= */
  ...
  OPT__param_file_cache_files_ = 103,        /* --param=file-cache-files= */
  OPT__param_file_cache_lines_ = 104,        /* --param=file-cache-lines= */
  OPT__param_fsm_scale_path_stmts_ = 105,    /* --param=fsm-scale-path-stmts= */
  OPT__param_fully_pipelined_fma_ = 106,     /* --param=fully-pipelined-fma= */
  ...
  OPT__param_hardcfr_max_blocks_ = 117,      /* --param=hardcfr-max-blocks= */
  OPT__param_hardcfr_max_inline_blocks_ = 118,/* --param=hardcfr-max-inline-blocks= */
  OPT__param_hash_table_verification_limit_ = 119,/* --param=hash-table-verification-limit= */
  OPT__param_hot_bb_count_fraction_ = 120,   /* --param=hot-bb-count-fraction= */
  OPT__param_hot_bb_count_ws_permille_ = 121,/* --param=hot-bb-count-ws-permille= */
  OPT__param_hot_bb_frequency_fraction_ = 122,/* --param=hot-bb-frequency-fraction= */
  OPT__param_hwasan_instrument_allocas_ = 123,/* --param=hwasan-instrument-allocas= */
  OPT__param_hwasan_instrument_mem_intrinsics_ = 124,/* --param=hwasan-instrument-mem-intrinsics= */
  OPT__param_hwasan_instrument_reads_ = 125, /* --param=hwasan-instrument-reads= */
  OPT__param_hwasan_instrument_stack_ = 126, /* --param=hwasan-instrument-stack= */
  OPT__param_hwasan_instrument_writes_ = 127,/* --param=hwasan-instrument-writes= */
  OPT__param_hwasan_random_frame_tag_ = 128, /* --param=hwasan-random-frame-tag= */
  OPT__param_inline_heuristics_hint_percent_ = 129,/* --param=inline-heuristics-hint-percent= */
  OPT__param_inline_min_speedup_ = 130,      /* --param=inline-min-speedup= */
  OPT__param_inline_unit_growth_ = 131,      /* --param=inline-unit-growth= */
  OPT__param_integer_share_limit_ = 132,     /* --param=integer-share-limit= */
  OPT__param_ipa_cp_eval_threshold_ = 133,   /* --param=ipa-cp-eval-threshold= */
  OPT__param_ipa_cp_large_unit_insns_ = 134, /* --param=ipa-cp-large-unit-insns= */
  OPT__param_ipa_cp_loop_hint_bonus_ = 135,  /* --param=ipa-cp-loop-hint-bonus= */
  OPT__param_ipa_cp_max_recursive_depth_ = 136,/* --param=ipa-cp-max-recursive-depth= */
  OPT__param_ipa_cp_min_recursive_probability_ = 137,/* --param=ipa-cp-min-recursive-probability= */
  ...
  OPT__param_ix86_vect_unroll_limit_ = 161,  /* --param=ix86-vect-unroll-limit= */
  OPT__param_jump_table_max_growth_ratio_for_size_ = 162,/* --param=jump-table-max-growth-ratio-for-size= */
  OPT__param_jump_table_max_growth_ratio_for_speed_ = 163,/* --param=jump-table-max-growth-ratio-for-speed= */
  OPT__param_l1_cache_line_size_ = 164,      /* --param=l1-cache-line-size= */
  OPT__param_l1_cache_size_ = 165,           /* --param=l1-cache-size= */
  OPT__param_l2_cache_size_ = 166,           /* --param=l2-cache-size= */
  OPT__param_large_function_growth_ = 167,   /* --param=large-function-growth= */
  OPT__param_large_function_insns_ = 168,    /* --param=large-function-insns= */
  OPT__param_large_stack_frame_growth_ = 169,/* --param=large-stack-frame-growth= */
  OPT__param_large_stack_frame_ = 170,       /* --param=large-stack-frame= */
  OPT__param_large_unit_insns_ = 171,        /* --param=large-unit-insns= */
  OPT__param_lazy_modules_ = 172,            /* --param=lazy-modules= */
  OPT__param_lim_expensive_ = 173,           /* --param=lim-expensive= */
  OPT__param_logical_op_non_short_circuit_ = 174,/* --param=logical-op-non-short-circuit= */
  OPT__param_loop_block_tile_size_ = 175,    /* --param=loop-block-tile-size= */
  OPT__param_loop_interchange_max_num_stmts_ = 176,/* --param=loop-interchange-max-num-stmts= */
  OPT__param_loop_interchange_stride_ratio_ = 177,/* --param=loop-interchange-stride-ratio= */
  OPT__param_loop_invariant_max_bbs_in_loop_ = 178,/* --param=loop-invariant-max-bbs-in-loop= */
  OPT__param_loop_max_datarefs_for_datadeps_ = 179,/* --param=loop-max-datarefs-for-datadeps= */
  OPT__param_loop_versioning_max_inner_insns_ = 180,/* --param=loop-versioning-max-inner-insns= */
  OPT__param_loop_versioning_max_outer_insns_ = 181,/* --param=loop-versioning-max-outer-insns= */
  OPT__param_lra_inheritance_ebb_probability_cutoff_ = 182,/* --param=lra-inheritance-ebb-probability-cutoff= */
  OPT__param_lra_max_considered_reload_pseudos_ = 183,/* --param=lra-max-considered-reload-pseudos= */
  OPT__param_lto_max_locality_partition_ = 184,/* --param=lto-max-locality-partition= */
  OPT__param_lto_max_partition_ = 185,       /* --param=lto-max-partition= */
  OPT__param_lto_max_streaming_parallelism_ = 186,/* --param=lto-max-streaming-parallelism= */
  OPT__param_lto_min_partition_ = 187,       /* --param=lto-min-partition= */
  OPT__param_lto_partition_locality_cloning_ = 188,/* --param=lto-partition-locality-cloning= */
  OPT__param_lto_partition_locality_frequency_cutoff_ = 189,/* --param=lto-partition-locality-frequency-cutoff= */
  OPT__param_lto_partition_locality_size_cutoff_ = 190,/* --param=lto-partition-locality-size-cutoff= */
  OPT__param_lto_partitions_ = 191,          /* --param=lto-partitions= */
  OPT__param_max_average_unrolled_insns_ = 192,/* --param=max-average-unrolled-insns= */
  OPT__param_max_combine_insns_ = 193,       /* --param=max-combine-insns= */
  OPT__param_max_combine_search_insns_ = 194,/* --param=max-combine-search-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 195,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 196,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 197,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 198,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 199,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 200,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 201,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 202,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 203,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 204,/* --param=max-delay-slot-live-search= */
  OPT__param_max_devirt_targets_ = 205,      /* --param=max-devirt-targets= */
  OPT__param_max_dse_active_local_stores_ = 206,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 207,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 208,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_find_base_term_values_ = 209,/* --param=max-find-base-term-values= */
  OPT__param_max_fsm_thread_path_insns_ = 210,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_gcse_insertion_ratio_ = 211,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 212,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 213,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 214,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 215,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_functions_called_once_insns_ = 216,/* --param=max-inline-functions-called-once-insns= */
  OPT__param_max_inline_functions_called_once_loop_depth_ = 217,/* --param=max-inline-functions-called-once-loop-depth= */
  OPT__param_max_inline_insns_auto_ = 218,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 219,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 220,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 221, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 222,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 223,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 224,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 225,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 226,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 227,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 228, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 229,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_jump_thread_paths_ = 230,   /* --param=max-jump-thread-paths= */
  OPT__param_max_last_value_rtl_ = 231,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 232,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 233,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 234,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 235,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 236,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 237,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 238, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 239,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 240,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 241,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 242,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 243, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 244,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 245,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 246,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 247,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 248,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 249,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 250, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 251,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 252,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 253,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 254,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_store_chains_to_track_ = 255,/* --param=max-store-chains-to-track= */
  OPT__param_max_stores_to_merge_ = 256,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 257,      /* --param=max-stores-to-sink= */
  OPT__param_max_stores_to_track_ = 258,     /* --param=max-stores-to-track= */
  OPT__param_max_tail_merge_comparisons_ = 259,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 260,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 261,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 262,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 263,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 264,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_depth_ = 265,      /* --param=max-unswitch-depth= */
  OPT__param_max_unswitch_insns_ = 266,      /* --param=max-unswitch-insns= */
  OPT__param_max_variable_expansions_in_unroller_ = 267,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 268, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 269,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 270,       /* --param=max-vartrack-size= */
  OPT__param_min_crossjump_insns_ = 271,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 272,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 273,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 274,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 275,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_pagesize_ = 276,            /* --param=min-pagesize= */
  OPT__param_min_size_for_stack_sharing_ = 277,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 278,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 279,     /* --param=min-vect-loop-bound= */
  OPT__param_modref_max_accesses_ = 280,     /* --param=modref-max-accesses= */
  OPT__param_modref_max_adjustments_ = 281,  /* --param=modref-max-adjustments= */
  OPT__param_modref_max_bases_ = 282,        /* --param=modref-max-bases= */
  OPT__param_modref_max_depth_ = 283,        /* --param=modref-max-depth= */
  OPT__param_modref_max_escape_points_ = 284,/* --param=modref-max-escape-points= */
  OPT__param_modref_max_refs_ = 285,         /* --param=modref-max-refs= */
  OPT__param_modref_max_tests_ = 286,        /* --param=modref-max-tests= */
  OPT__param_openacc_kernels_ = 287,         /* --param=openacc-kernels= */
  OPT__param_openacc_privatization_ = 288,   /* --param=openacc-privatization= */
  OPT__param_parloops_chunk_size_ = 289,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 290, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 291,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 292,/* --param=partial-inlining-entry-probability= */
  OPT__param_phiopt_factor_max_stmts_live_ = 293,/* --param=phiopt-factor-max-stmts-live= */
  OPT__param_predictable_branch_outcome_ = 294,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 295,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 296,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 297,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 298, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 299,/* --param=profile-func-internal-id= */
  OPT__param_ranger_debug_ = 300,            /* --param=ranger-debug= */
  OPT__param_ranger_logical_depth_ = 301,    /* --param=ranger-logical-depth= */
  OPT__param_ranger_recompute_depth_ = 302,  /* --param=ranger-recompute-depth= */
  OPT__param_relation_block_limit_ = 303,    /* --param=relation-block-limit= */
  OPT__param_rpo_vn_max_loop_depth_ = 304,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 305,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 306,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 307,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 308,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 309, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 310,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 311,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 312,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 313,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 314,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 315,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 316, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 317,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 318,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 319,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 320,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 321,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 322,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 323,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 324,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 325,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 326,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 327,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 328,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_forwarding_max_distance_ = 329,/* --param=store-forwarding-max-distance= */
  OPT__param_store_merging_allow_unaligned_ = 330,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 331,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 332,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_switch_lower_slow_alg_max_cases_ = 333,/* --param=switch-lower-slow-alg-max-cases= */
  OPT__param_threader_debug_ = 334,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 335,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 336,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 337, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 338,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 339,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 340,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 341, /* --param=tracer-min-branch-ratio= */
  OPT__param_transitive_relations_work_bound_ = 342,/* --param=transitive-relations-work-bound= */
  OPT__param_tree_reassoc_width_ = 343,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 344,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 345,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 346,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninit_max_chain_len_ = 347,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 348,   /* --param=uninit-max-num-chains= */
  OPT__param_uninit_max_prune_work_ = 349,   /* --param=uninit-max-prune-work= */
  OPT__param_uninlined_function_insns_ = 350,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 351, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 352,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 353,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 354,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 355,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 356,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 357,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 358,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 359,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_induction_float_ = 360,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 361,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 362,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 363,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 364,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 365,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 366,/* --param=vect-partial-vector-usage= */
  OPT__param_vect_scalar_cost_multiplier_ = 367,/* --param=vect-scalar-cost-multiplier= */
  OPT__param_vrp_block_limit_ = 368,         /* --param=vrp-block-limit= */
  OPT__param_vrp_sparse_threshold_ = 369,    /* --param=vrp-sparse-threshold= */
  OPT__param_vrp_switch_limit_ = 370,        /* --param=vrp-switch-limit= */
  OPT__param_vrp_vector_threshold_ = 371,    /* --param=vrp-vector-threshold= */
  OPT__param_x86_stlf_window_ninsns_ = 372,  /* --param=x86-stlf-window-ninsns= */
  OPT__param_x86_stv_max_visits_ = 373,      /* --param=x86-stv-max-visits= */
  /* OPT__pass_exit_codes = 374, */          /* --pass-exit-codes */
  /* OPT__pedantic = 375, */                 /* --pedantic */
  /* OPT__pedantic_errors = 376, */          /* --pedantic-errors */
  /* OPT__pie = 377, */                      /* --pie */
  /* OPT__pipe = 378, */                     /* --pipe */
  /* OPT__prefix = 379, */                   /* --prefix */
  /* OPT__prefix_ = 380, */                  /* --prefix= */
  /* OPT__preprocess = 381, */               /* --preprocess */
  /* OPT__print_file_name = 382, */          /* --print-file-name */
  /* OPT__print_file_name_ = 383, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 384, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 385, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 386, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 387, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 388, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 389, */          /* --print-multiarch */
  /* OPT__print_prog_name = 390, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 391, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 392, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 393, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 394, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 395, */                  /* --profile */
  /* OPT__save_temps = 396, */               /* --save-temps */
  /* OPT__shared = 397, */                   /* --shared */
  /* OPT__specs = 398, */                    /* --specs */
  /* OPT__specs_ = 399, */                   /* --specs= */
  /* OPT__static = 400, */                   /* --static */
  /* OPT__static_pie = 401, */               /* --static-pie */
  /* OPT__symbolic = 402, */                 /* --symbolic */
  /* OPT__sysroot = 403, */                  /* --sysroot */
  OPT__sysroot_ = 404,                       /* --sysroot= */
  OPT__target_help = 405,                    /* --target-help */
  /* OPT__time = 406, */                     /* --time */
  /* OPT__trace_includes = 407, */           /* --trace-includes */
  /* OPT__traditional = 408, */              /* --traditional */
  /* OPT__traditional_cpp = 409, */          /* --traditional-cpp */
  /* OPT__trigraphs = 410, */                /* --trigraphs */
  /* OPT__undefine_macro = 411, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 412, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 413, */        /* --user-dependencies */
  /* OPT__verbose = 414, */                  /* --verbose */
  OPT__version = 415,                        /* --version */
  /* OPT__write_dependencies = 416, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 417, */  /* --write-user-dependencies */
  OPT_A = 418,                               /* -A */
  OPT_B = 419,                               /* -B */
  OPT_C = 420,                               /* -C */
  OPT_CC = 421,                              /* -CC */
  ...
  OPT_MQ = 438,                              /* -MQ */
  OPT_MT = 439,                              /* -MT */
  OPT_Mmodules = 440,                        /* -Mmodules */
  OPT_Mno_modules = 441,                     /* -Mno-modules */
  OPT_N = 442,                               /* -N */
  OPT_O = 443,                               /* -O */
  OPT_Ofast = 444,                           /* -Ofast */
  OPT_Og = 445,                              /* -Og */
  ...
  OPT_Tbss_ = 456,                           /* -Tbss= */
  OPT_Tdata = 457,                           /* -Tdata */
  OPT_Tdata_ = 458,                          /* -Tdata= */
  OPT_Ttext = 459,                           /* -Ttext */
  OPT_Ttext_ = 460,                          /* -Ttext= */
  OPT_U = 461,                               /* -U */
  /* OPT_W = 462, */                         /* -W */
  OPT_WNSObject_attribute = 463,             /* -WNSObject-attribute */
  OPT_Wa_ = 464,                             /* -Wa, */
  OPT_Wabbreviated_auto_in_template_arg = 465,/* -Wabbreviated-auto-in-template-arg */
  OPT_Wabi = 466,                            /* -Wabi */
  ...
  OPT_Wanalyzer_throw_of_unexpected_type = 523,/* -Wanalyzer-throw-of-unexpected-type */
  OPT_Wanalyzer_too_complex = 524,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 525,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 526,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 527,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 528,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 529,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 530,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 531,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 532,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 533,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 534,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 535,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 536,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 537,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 538,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 539, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 540,                  /* -Warray-bounds= */
  OPT_Warray_compare = 541,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 542, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 543,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 544,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 545,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 546, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 547,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 548,              /* -Wattribute-warning */
  OPT_Wattributes = 549,                     /* -Wattributes */
  OPT_Wattributes_ = 550,                    /* -Wattributes= */
  OPT_Wauto_profile = 551,                   /* -Wauto-profile */
  OPT_Wbad_function_cast = 552,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 553, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 554,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 555,                   /* -Wbool-compare */
  OPT_Wbool_operation = 556,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 557,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 558,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 559,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 560, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 561,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 562,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 563,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 564,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 565,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 566,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 567, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 568,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 569,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 570,               /* -Wc++23-extensions */
  OPT_Wc__26_compat = 571,                   /* -Wc++26-compat */
  OPT_Wc__26_extensions = 572,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 573, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 574,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 575,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 576, */           /* -Wc11-c2x-compat */
  OPT_Wc23_c2y_compat = 577,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 578,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 579,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 580,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 581,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 582,                      /* -Wcase-enum */
  OPT_Wcast_align = 583,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 584,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 585,             /* -Wcast-function-type */
  OPT_Wcast_qual = 586,                      /* -Wcast-qual */
  OPT_Wcast_result = 587,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 588,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 589, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 590,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 591,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 592,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 593,           /* -Wcharacter-truncation */
  OPT_Wchkp = 594,                           /* -Wchkp */
  OPT_Wclass_conversion = 595,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 596,                /* -Wclass-memaccess */
  OPT_Wclobbered = 597,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 598,                /* -Wcomma-subscript */
  OPT_Wcomment = 599,                        /* -Wcomment */
  /* OPT_Wcomments = 600, */                 /* -Wcomments */
  OPT_Wcompare_distinct_pointer_types = 601, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 602,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 603,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 604,        /* -Wconditionally-supported */
  OPT_Wconversion = 605,                     /* -Wconversion */
  OPT_Wconversion_extra = 606,               /* -Wconversion-extra */
  OPT_Wconversion_null = 607,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 608,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 609,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 610,   /* -Wcoverage-too-many-conditions */
  OPT_Wcoverage_too_many_paths = 611,        /* -Wcoverage-too-many-paths */
  OPT_Wcpp = 612,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 613,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 614,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 615,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 616, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 617,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 618,             /* -Wdangling-reference */
  OPT_Wdate_time = 619,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 620,    /* -Wdeclaration-after-statement */
  OPT_Wdeclaration_missing_parameter_type = 621,/* -Wdeclaration-missing-parameter-type */
  OPT_Wdefaulted_function_deleted = 622,     /* -Wdefaulted-function-deleted */
  OPT_Wdelete_incomplete = 623,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 624,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 625,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 626,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 627,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 628,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 629,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 630,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdeprecated_literal_operator = 631,    /* -Wdeprecated-literal-operator */
  OPT_Wdeprecated_non_prototype = 632,       /* -Wdeprecated-non-prototype */
  OPT_Wdeprecated_variadic_comma_omission = 633,/* -Wdeprecated-variadic-comma-omission */
  OPT_Wdesignated_init = 634,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 635,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 636,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 637,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 638,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 639,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 640,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 641,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 642,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 643,                /* -Wduplicated-cond */
  OPT_Weffc__ = 644,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 645,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 646,                     /* -Wempty-body */
  OPT_Wendif_labels = 647,                   /* -Wendif-labels */
  OPT_Wenum_compare = 648,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 649,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 650,              /* -Wenum-int-mismatch */
  OPT_Werror = 651,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 652, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 653,                         /* -Werror= */
  OPT_Wexceptions = 654,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 655,           /* -Wexpansion-to-defined */
  OPT_Wexternal_argument_mismatch = 656,     /* -Wexternal-argument-mismatch */
  OPT_Wexternal_tu_local = 657,              /* -Wexternal-tu-local */
  OPT_Wextra = 658,                          /* -Wextra */
  OPT_Wextra_semi = 659,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 660,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 661,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 662,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 663,                    /* -Wfloat-equal */
  /* OPT_Wformat = 664, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 665,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 666,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 667,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 668,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 669, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 670,               /* -Wformat-overflow= */
  OPT_Wformat_security = 671,                /* -Wformat-security */
  OPT_Wformat_signedness = 672,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 673, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 674,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 675,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 676,             /* -Wformat-zero-length */
  OPT_Wformat_ = 677,                        /* -Wformat= */
  OPT_Wframe_address = 678,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 679,             /* -Wframe-larger-than= */
  OPT_Wfree_labels = 680,                    /* -Wfree-labels */
  OPT_Wfree_nonheap_object = 681,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 682,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 683,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 684,                  /* -Wglobal-module */
  OPT_Whardened = 685,                       /* -Whardened */
  OPT_Wheader_guard = 686,                   /* -Wheader-guard */
  /* OPT_Whsa = 687, */                      /* -Whsa */
  OPT_Wif_not_aligned = 688,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 689,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 690,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 691,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 692, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 693,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 694,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 695,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 696,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 697,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 698, */                   /* -Wimport */
  OPT_Winaccessible_base = 699,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 700,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 701,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 702,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 703,             /* -Winit-list-lifetime */
  OPT_Winit_self = 704,                      /* -Winit-self */
  OPT_Winline = 705,                         /* -Winline */
  OPT_Wint_conversion = 706,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 707,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 708,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 709,               /* -Winteger-division */
  OPT_Winterference_size = 710,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 711,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 712,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 713,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 714,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 715,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 716,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 717,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 718,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 719,               /* -Wjump-misses-init */
  OPT_Wkeyword_macro = 720,                  /* -Wkeyword-macro */
  OPT_Wl_ = 721,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 722, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 723,                   /* -Wlarger-than= */
  OPT_Wleading_whitespace_ = 724,            /* -Wleading-whitespace= */
  OPT_Wline_truncation = 725,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 726,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 727,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 728,                     /* -Wlogical-op */
  OPT_Wlong_long = 729,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 730,              /* -Wlto-type-mismatch */
  OPT_Wmain = 731,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 732,      /* -Wmaybe-musttail-local-addr */
  OPT_Wmaybe_uninitialized = 733,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 734,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 735,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 736,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 737,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 738,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 739,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 740,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 741,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 742,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 743,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 744,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 745, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 746,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 747, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_name = 748,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 749,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 750,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 751,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 752,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 753,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 754,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 755,                        /* -Wmudflap */
  OPT_Wmultichar = 756,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 757,           /* -Wmultiple-inheritance */
  OPT_Wmultiple_parameter_fwd_decl_lists = 758,/* -Wmultiple-parameter-fwd-decl-lists */
  OPT_Wmultistatement_macros = 759,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 760,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 761,                     /* -Wnamespaces */
  OPT_Wnarrowing = 762,                      /* -Wnarrowing */
  OPT_Wnested_externs = 763,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 764, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 765, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 766, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 767, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 768, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 769, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 770,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 771,                  /* -Wnoexcept-type */
  OPT_Wnon_c_typedef_for_linkage = 772,      /* -Wnon-c-typedef-for-linkage */
  OPT_Wnon_template_friend = 773,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 774,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 775,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 776,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 777, */               /* -Wnormalized */
  OPT_Wnormalized_ = 778,                    /* -Wnormalized= */
  OPT_Wnrvo = 779,                           /* -Wnrvo */
  OPT_Wnull_dereference = 780,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 781,                /* -Wobjc-root-class */
  OPT_Wodr = 782,                            /* -Wodr */
  OPT_Wold_style_cast = 783,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 784,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 785,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 786,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 787,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 788,                    /* -Wopenmp-simd */
  OPT_Woverflow = 789,                       /* -Woverflow */
  OPT_Woverlength_strings = 790,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 791, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 792,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 793,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 794,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 795,            /* -Woverwrite-recursive */
  OPT_Wp_ = 796,                             /* -Wp, */
  OPT_Wpacked = 797,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 798,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 799,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 800,                         /* -Wpadded */
  OPT_Wparentheses = 801,                    /* -Wparentheses */
  OPT_Wpedantic = 802,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 803,                  /* -Wpedantic-cast */
  OPT_Wpedantic_ms_format = 804,             /* -Wpedantic-ms-format */
  OPT_Wpedantic_param_names = 805,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 806,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 807, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 808,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 809,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 810,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 811,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 812,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 813,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 814,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 815,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 816,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 817,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 818,                       /* -Wprotocol */
  OPT_Wpsabi = 819,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 820,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 821,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 822,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 823,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 824,                /* -Wredundant-decls */
  OPT_Wredundant_move = 825,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 826,                 /* -Wredundant-tags */
  OPT_Wregister = 827,                       /* -Wregister */
  OPT_Wreorder = 828,                        /* -Wreorder */
  OPT_Wrestrict = 829,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 830,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 831,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 832,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 833,           /* -Wscalar-storage-order */
  OPT_Wselector = 834,                       /* -Wselector */
  OPT_Wself_move = 835,                      /* -Wself-move */
  OPT_Wsequence_point = 836,                 /* -Wsequence-point */
  /* OPT_Wsfinae_incomplete = 837, */        /* -Wsfinae-incomplete */
  OPT_Wsfinae_incomplete_ = 838,             /* -Wsfinae-incomplete= */
  OPT_Wshadow = 839,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 840, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 841,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 842, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 843,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 844, */            /* -Wshadow=global */
  OPT_Wshadow_local = 845,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 846,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 847,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 848,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 849, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 850,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 851,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 852,                /* -Wsign-conversion */
  OPT_Wsign_promo = 853,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 854,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 855,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 856,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 857,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 858,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 859,                    /* -Wspeculative */
  OPT_Wstack_protector = 860,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 861,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 862,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 863,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 864,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 865,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 866,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 867,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 868,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 869,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 870,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 871, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 872,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 873,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 874,            /* -Wstringop-truncation */
  OPT_Wstyle = 875,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 876,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 877,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 878,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 879,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 880,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 881,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 882,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 883,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 884,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 885,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 886,               /* -Wsuggest-override */
  OPT_Wsurprising = 887,                     /* -Wsurprising */
  OPT_Wswitch = 888,                         /* -Wswitch */
  OPT_Wswitch_bool = 889,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 890,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 891,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 892,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 893,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 894,                      /* -Wsync-nand */
  OPT_Wsynth = 895,                          /* -Wsynth */
  OPT_Wsystem_headers = 896,                 /* -Wsystem-headers */
  OPT_Wtabs = 897,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 898,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 899,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 900,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 901,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 902,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 903,                      /* -Wtemplates */
  OPT_Wterminate = 904,                      /* -Wterminate */
  OPT_Wtraditional = 905,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 906,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 907, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 908,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 909,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 910,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 911,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 912,                           /* -Wtsan */
  OPT_Wtype_limits = 913,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 914,            /* -Wundeclared-selector */
  OPT_Wundef = 915,                          /* -Wundef */
  OPT_Wundefined_do_loop = 916,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 917,                      /* -Wunderflow */
  OPT_Wunicode = 918,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 919,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 920,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 921,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 922,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 923, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 924, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 925,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 926,/* -Wunterminated-string-initialization */
  OPT_Wunused = 927,                         /* -Wunused */
  /* OPT_Wunused_but_set_parameter = 928, */ /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_parameter_ = 929,      /* -Wunused-but-set-parameter= */
  /* OPT_Wunused_but_set_variable = 930, */  /* -Wunused-but-set-variable */
  OPT_Wunused_but_set_variable_ = 931,       /* -Wunused-but-set-variable= */
  /* OPT_Wunused_const_variable = 932, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 933,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 934,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 935,                /* -Wunused-function */
  OPT_Wunused_label = 936,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 937,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 938,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 939,               /* -Wunused-parameter */
  OPT_Wunused_result = 940,                  /* -Wunused-result */
  OPT_Wunused_value = 941,                   /* -Wunused-value */
  OPT_Wunused_variable = 942,                /* -Wunused-variable */
  OPT_Wuse_after_free = 943,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 944,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 945,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 946,                   /* -Wuseless-cast */
  OPT_Wvarargs = 947,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 948,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 949,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 950,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 951,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 952,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 953,            /* -Wvirtual-move-assign */
  OPT_Wvla = 954,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 955,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 956,                  /* -Wvla-parameter */
  OPT_Wvolatile = 957,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 958,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 959,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 960,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 961,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 962,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 963,                       /* -Wzerotrip */
  OPT_X = 964,                               /* -X */
  OPT_Xassembler = 965,                      /* -Xassembler */
  OPT_Xf = 966,                              /* -Xf */
  OPT_Xlinker = 967,                         /* -Xlinker */
  OPT_Xpreprocessor = 968,                   /* -Xpreprocessor */
  OPT_Z = 969,                               /* -Z */
  OPT_ansi = 970,                            /* -ansi */
  OPT_aux_info = 971,                        /* -aux-info */
  /* OPT_aux_info_ = 972, */                 /* -aux-info= */
  OPT_c = 973,                               /* -c */
  OPT_callgraph = 974,                       /* -callgraph */
  OPT_copyext = 975,                         /* -copyext */
  OPT_coverage = 976,                        /* -coverage */
  OPT_cpp = 977,                             /* -cpp */
  OPT_cpp_ = 978,                            /* -cpp= */
  OPT_d = 979,                               /* -d */
  OPT_debuglib_ = 980,                       /* -debuglib= */
  OPT_defaultlib_ = 981,                     /* -defaultlib= */
  OPT_defined_only = 982,                    /* -defined-only */
  OPT_demangle = 983,                        /* -demangle */
  OPT_dialect = 984,                         /* -dialect */
  OPT_dstartfiles = 985,                     /* -dstartfiles */
  OPT_dump_body_ = 986,                      /* -dump-body= */
  OPT_dump_level_ = 987,                     /* -dump-level= */
  OPT_dumpbase = 988,                        /* -dumpbase */
  OPT_dumpbase_ext = 989,                    /* -dumpbase-ext */
  OPT_dumpdir = 990,                         /* -dumpdir */
  OPT_dumpfullversion = 991,                 /* -dumpfullversion */
  OPT_dumpmachine = 992,                     /* -dumpmachine */
  OPT_dumpspecs = 993,                       /* -dumpspecs */
  OPT_dumpversion = 994,                     /* -dumpversion */
  OPT_e = 995,                               /* -e */
  OPT_export_dynamic = 996,                  /* -export-dynamic */
  OPT_fPIC = 997,                            /* -fPIC */
  OPT_fPIE = 998,                            /* -fPIE */
  OPT_fRTS_ = 999,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 1000,           /* -fabi-compat-version= */
  OPT_fabi_version_ = 1001,                  /* -fabi-version= */
  OPT_faccess_control = 1002,                /* -faccess-control */
  OPT_fada_spec_parent_ = 1003,              /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 1004,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 1005, /* -faggressive-loop-optimizations */
  OPT_falign_commons = 1006,                 /* -falign-commons */
  OPT_falign_functions = 1007,               /* -falign-functions */
  OPT_falign_functions_ = 1008,              /* -falign-functions= */
  OPT_falign_jumps = 1009,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1010,                  /* -falign-jumps= */
  OPT_falign_labels = 1011,                  /* -falign-labels */
  OPT_falign_labels_ = 1012,                 /* -falign-labels= */
  OPT_falign_loops = 1013,                   /* -falign-loops */
  OPT_falign_loops_ = 1014,                  /* -falign-loops= */
  /* OPT_faligned_new = 1015, */             /* -faligned-new */
  OPT_faligned_new_ = 1016,                  /* -faligned-new= */
  OPT_fall_instantiations = 1017,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1018,                /* -fall-intrinsics */
  OPT_fall_virtual = 1019,                   /* -fall-virtual */
  OPT_fallocation_dce = 1020,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1021,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1022,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1023,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1024, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1025,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1026,        /* -falt-external-templates */
  OPT_fanalyzer = 1027,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1028,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1029,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1030,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1031,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1032,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1033, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1034,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1035,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1036,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1037,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1038,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1039,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1040,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1041,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1042,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1043, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1044, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1045, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1046, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1047,           /* -fasan-shadow-offset= */
  OPT_fasm = 1048,                           /* -fasm */
  OPT_fassert = 1049,                        /* -fassert */
  OPT_fassociative_math = 1050,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1051,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1052,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1053,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1054,                     /* -fauto-init */
  OPT_fauto_profile = 1055,                  /* -fauto-profile */
  OPT_fauto_profile_inlining = 1056,         /* -fauto-profile-inlining */
  OPT_fauto_profile_ = 1057,                 /* -fauto-profile= */
  OPT_fautomatic = 1058,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1059,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1060,                     /* -fbackslash */
  OPT_fbacktrace = 1061,                     /* -fbacktrace */
  OPT_fbit_tests = 1062,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1063,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1064,                        /* -fbounds */
  OPT_fbounds_check = 1065,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1066,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1067,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1068,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1069, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1070, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1071, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1072,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1073,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1074,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1075,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1076,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1077,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1078,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1079,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1080,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1081,                    /* -fcall-used- */
  OPT_fcaller_saves = 1082,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1083,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1084,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1085,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1086,      /* -fcanonical-system-headers */
  OPT_fcase = 1087,                          /* -fcase */
  /* OPT_fcf_protection = 1088, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1089,                /* -fcf-protection= */
  OPT_fchar8_t = 1090,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1091,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1092, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1093,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1094,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1095,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1096, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1097, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1098, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1099, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1100, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1101, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1102,                  /* -fcheckaction= */
  OPT_fchecking = 1103,                      /* -fchecking */
  OPT_fchecking_ = 1104,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1105,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1106,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1107,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1108,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1109,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1110,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1111,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1112,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1113,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1114,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1115,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1116,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1117,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1118,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1119,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1120,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1121,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1122,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1123, */                /* -fcilkplus */
  OPT_fcoarray_ = 1124,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1125,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1126,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1127,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1128,                        /* -fcommon */
  OPT_fcompare_debug = 1129,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1130,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1131,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1132,                  /* -fcompare-elim */
  OPT_fconcepts = 1133,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1134,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1135,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1136,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1137,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1138, */          /* -fconserve-space */
  OPT_fconserve_stack = 1139,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1140,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1141,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1142,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1143,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1144,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1145,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1146,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1147,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1148,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1149,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1150,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1151,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1152, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1153,                     /* -fcontracts */
  OPT_fconvert_ = 1154,                      /* -fconvert= */
  OPT_fcoroutines = 1155,                    /* -fcoroutines */
  OPT_fcpp = 1156,                           /* -fcpp */
  OPT_fcpp_begin = 1157,                     /* -fcpp-begin */
  OPT_fcpp_end = 1158,                       /* -fcpp-end */
  OPT_fcprop_registers = 1159,               /* -fcprop-registers */
  OPT_fcray_pointer = 1160,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1161,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1162,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1163, */         /* -fcse-skip-blocks */
  /* OPT_fcx_fortran_rules = 1164, */        /* -fcx-fortran-rules */
  /* OPT_fcx_limited_range = 1165, */        /* -fcx-limited-range */
  OPT_fcx_method_ = 1166,                    /* -fcx-method= */
  OPT_fd = 1167,                             /* -fd */
  OPT_fd_lines_as_code = 1168,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1169,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1170,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1171,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1172,                      /* -fdbg-cnt= */
  OPT_fdce = 1173,                           /* -fdce */
  OPT_fdebug = 1174,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1175,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1176,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1177,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1178,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1179,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1180,           /* -fdebug-types-section */
  OPT_fdebug_ = 1181,                        /* -fdebug= */
  OPT_fdec = 1182,                           /* -fdec */
  OPT_fdec_blank_format_item = 1183,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1184,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1185,           /* -fdec-format-defaults */
  OPT_fdec_include = 1186,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1187,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1188,                      /* -fdec-math */
  OPT_fdec_static = 1189,                    /* -fdec-static */
  OPT_fdec_structure = 1190,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1191,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1192, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1193,                          /* -fdef= */
  OPT_fdefault_double_8 = 1194,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1195, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1196,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1197,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1198,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1199,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1200,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1201,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1202,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1203,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1204,    /* -fdelete-null-pointer-checks */
  OPT_fdep_fusion = 1205,                    /* -fdep-fusion */
  OPT_fdeps_file_ = 1206,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1207,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1208,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1209,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1210,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1211,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1212,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1213,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1214, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1215,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1216,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1217,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1218,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1219,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1220,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1221,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1222,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1223,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1224,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1225,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1226,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1227,        /* -fdiagnostics-show-caret */
  /* OPT_fdiagnostics_show_context = 1228, *//* -fdiagnostics-show-context */
  OPT_fdiagnostics_show_context_ = 1229,     /* -fdiagnostics-show-context= */
  OPT_fdiagnostics_show_cwe = 1230,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1231,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1232,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1233,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1234, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1235,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_nesting = 1236,      /* -fdiagnostics-show-nesting */
  OPT_fdiagnostics_show_nesting_levels = 1237,/* -fdiagnostics-show-nesting-levels */
  OPT_fdiagnostics_show_nesting_locations = 1238,/* -fdiagnostics-show-nesting-locations */
  OPT_fdiagnostics_show_option = 1239,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1240,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1241,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1242,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1243, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1244,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1245,               /* -fdirectives-only */
  OPT_fdisable_ = 1246,                      /* -fdisable- */
  OPT_fdoc = 1247,                           /* -fdoc */
  OPT_fdoc_dir_ = 1248,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1249,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1250,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1251,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1252,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1253,                      /* -fdruntime */
  OPT_fdse = 1254,                           /* -fdse */
  OPT_fdump_ = 1255,                         /* -fdump- */
  OPT_fdump_ada_spec = 1256,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1257,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1258,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1259,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1260,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1261,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1262,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1263,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1264,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1265,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1266,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1267,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1268,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1269,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1270,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1271,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1272,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1273,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1274, */               /* -fdump-core */
  OPT_fdump_d_original = 1275,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1276,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1277,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1278,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1279,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1280,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1281,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1282,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1283,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1284, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1285,                   /* -fdump-passes */
  OPT_fdump_scos = 1286,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1287,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1288,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1289,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1290,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1291,                /* -fearly-inlining */
  OPT_felide_constructors = 1292,            /* -felide-constructors */
  OPT_felide_type = 1293,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1294, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1295,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1296,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1297,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1298,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1299,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1300,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1301,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1302,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1303,                /* -fenum-int-equiv */
  OPT_fexceptions = 1304,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1305,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1306,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1307,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1308,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1309,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1310,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1311,               /* -fextended-opaque */
  OPT_fextern_std_ = 1312,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1313,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1314,                 /* -fexternal-blas */
  OPT_fexternal_blas64 = 1315,               /* -fexternal-blas64 */
  OPT_fexternal_templates = 1316,            /* -fexternal-templates */
  OPT_ff2c = 1317,                           /* -ff2c */
  OPT_ffast_math = 1318,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1319,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1320,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1321,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1322,              /* -ffinite-math-only */
  OPT_ffixed_ = 1323,                        /* -ffixed- */
  OPT_ffixed_form = 1324,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1325,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1326,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1327,                    /* -fflex-debug */
  OPT_ffloat_store = 1328,                   /* -ffloat-store */
  OPT_ffloatvalue = 1329,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1330,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1331,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1332,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1333, */              /* -fforce-addr */
  OPT_fforward_propagate = 1334,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1335,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1336,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1337,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1338,                     /* -ffpe-trap= */
  OPT_ffree_form = 1339,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1340,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1341,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1342,                  /* -ffreestanding */
  OPT_ffriend_injection = 1343,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1344,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1345,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1346,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1347,             /* -ffunction-sections */
  OPT_fgcse = 1348,                          /* -fgcse */
  OPT_fgcse_after_reload = 1349,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1350,                      /* -fgcse-las */
  OPT_fgcse_lm = 1351,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1352,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1353,              /* -fgen-module-list= */
  OPT_fgimple = 1354,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1355,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1356,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1357,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1358,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1359,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1360,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1361,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1362,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1363,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1364,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1365,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1366,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1367,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1368,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1369,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1370,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1371,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1372,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1373,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1374,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1375,                      /* -fgraphite */
  OPT_fgraphite_identity = 1376,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1377,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1378,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1379, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1380,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1381, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1382, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1383,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1384,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1385,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1386,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1387,                      /* -fhardened */
  /* OPT_fhelp = 1388, */                    /* -fhelp */
  /* OPT_fhelp_ = 1389, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1390,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1391,                     /* -fhonor-std */
  OPT_fhosted = 1392,                        /* -fhosted */
  OPT_fhuge_objects = 1393,                  /* -fhuge-objects */
  OPT_fident = 1394,                         /* -fident */
  OPT_fif_conversion = 1395,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1396,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1397,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1398,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1399,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1400,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1401,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1402,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1403,            /* -fimplicit-templates */
  OPT_finclude_imports = 1404,               /* -finclude-imports */
  OPT_findex = 1405,                         /* -findex */
  OPT_findicator_column = 1406,              /* -findicator-column */
  OPT_findirect_inlining = 1407,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1408,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1409,               /* -finit-character= */
  OPT_finit_derived = 1410,                  /* -finit-derived */
  OPT_finit_integer_ = 1411,                 /* -finit-integer= */
  OPT_finit_local_zero = 1412,               /* -finit-local-zero */
  OPT_finit_logical_ = 1413,                 /* -finit-logical= */
  OPT_finit_real_ = 1414,                    /* -finit-real= */
  OPT_finline = 1415,                        /* -finline */
  OPT_finline_arg_packing = 1416,            /* -finline-arg-packing */
  OPT_finline_atomics = 1417,                /* -finline-atomics */
  OPT_finline_functions = 1418,              /* -finline-functions */
  OPT_finline_functions_called_once = 1419,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1420,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1421,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1422, */           /* -finline-limit- */
  OPT_finline_limit_ = 1423,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1424,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1425,        /* -finline-small-functions */
  OPT_finline_stringops = 1426,              /* -finline-stringops */
  OPT_finline_stringops_ = 1427,             /* -finline-stringops= */
  OPT_finput_charset_ = 1428,                /* -finput-charset= */
  OPT_finstrument_functions = 1429,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1430,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1431,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1432,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1433,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1434,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1435,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1436,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1437,                    /* -finvariants */
  OPT_fipa_bit_cp = 1438,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1439,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1440, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1441,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1442,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1443,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1444,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1445, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1446,                    /* -fipa-modref */
  OPT_fipa_profile = 1447,                   /* -fipa-profile */
  OPT_fipa_pta = 1448,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1449,                /* -fipa-pure-const */
  OPT_fipa_ra = 1450,                        /* -fipa-ra */
  OPT_fipa_reference = 1451,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1452,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1453,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1454,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1455,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1456,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1457, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1458,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1459,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1460,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1461,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1462,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1463,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1464,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1465,                  /* -fira-verbose= */
  OPT_fiso = 1466,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1467,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1468,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1469,              /* -fivar-visibility= */
  OPT_fivopts = 1470,                        /* -fivopts */
  OPT_fjump_tables = 1471,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1472,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1473,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1474,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1475,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1476,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1477,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1478,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1479,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1480,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1481,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1482,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1483, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1484,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1485,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1486,            /* -fleading-underscore */
  OPT_flibs_ = 1487,                         /* -flibs= */
  OPT_flifetime_dse = 1488,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1489,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1490,      /* -flimit-function-alignment */
  OPT_flink_libatomic = 1491,                /* -flink-libatomic */
  OPT_flinker_output_ = 1492,                /* -flinker-output= */
  /* OPT_flive_patching = 1493, */           /* -flive-patching */
  OPT_flive_patching_ = 1494,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1495,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1496,                   /* -flocal-ivars */
  OPT_flocation_ = 1497,                     /* -flocation= */
  /* OPT_floop_block = 1498, */              /* -floop-block */
  /* OPT_floop_flatten = 1499, */            /* -floop-flatten */
  OPT_floop_interchange = 1500,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1501,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1502, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1503,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1504, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1505,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1506,                     /* -flra-remat */
  OPT_flto = 1507,                           /* -flto */
  OPT_flto_compression_level_ = 1508,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1509,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1510,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1511, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1512,                /* -flto-partition= */
  OPT_flto_report = 1513,                    /* -flto-report */
  OPT_flto_report_wpa = 1514,                /* -flto-report-wpa */
  OPT_flto_ = 1515,                          /* -flto= */
  OPT_fltrans = 1516,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1517,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1518,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1519,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1520,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1521,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1522,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1523,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1524,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1525,                          /* -fm2-g */
  OPT_fm2_lower_case = 1526,                 /* -fm2-lower-case */
  OPT_fm2_pathname_root_ = 1527,             /* -fm2-pathname-root= */
  OPT_fm2_pathname_rootI_ = 1528,            /* -fm2-pathname-rootI= */
  OPT_fm2_pathname_ = 1529,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1530,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1531,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1532,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1533,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1534,                /* -fm2-strict-type */
  OPT_fm2_strict_type_reason = 1535,         /* -fm2-strict-type-reason */
  OPT_fm2_whole_program = 1536,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1537,             /* -fmacro-prefix-map= */
  OPT_fmain = 1538,                          /* -fmain */
  OPT_fmalloc_dce = 1539,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1540,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1541,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1542,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1543,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1544,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1545,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1546,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1547,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1548,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1549,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1550,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1551,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1552,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1553,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1554,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1555,                          /* -fmod= */
  OPT_fmodule_file_ = 1556,                  /* -fmodule-file= */
  OPT_fmodule_header = 1557,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1558,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1559,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1560,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1561,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1562,                   /* -fmodule-only */
  OPT_fmodule_private = 1563,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1564,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1565,                    /* -fmoduleinfo */
  OPT_fmodules = 1566,                       /* -fmodules */
  /* OPT_fmodules_ts = 1567, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1568,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1569,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1570,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1571,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1572,                 /* -fms-extensions */
  OPT_fmudflap = 1573,                       /* -fmudflap */
  OPT_fmudflapir = 1574,                     /* -fmudflapir */
  OPT_fmudflapth = 1575,                     /* -fmudflapth */
  OPT_fmultiflags = 1576,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1577,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1578,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1579,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1580,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1581,                  /* -fnext-runtime */
  OPT_fnil = 1582,                           /* -fnil */
  OPT_fnil_receivers = 1583,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1584,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1585,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1586,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1587,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1588,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1589,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1590,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1591,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1592,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1593,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1594,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1595,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1596,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1597,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1598,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1599,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1600,              /* -foffload-options= */
  OPT_foffload_ = 1601,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1602,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1603,                         /* -fonly= */
  OPT_fopenacc = 1604,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1605,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1606,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1607,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1608,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1609, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1610,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1611,                /* -foperator-names */
  OPT_fopt_info = 1612,                      /* -fopt-info */
  OPT_fopt_info_ = 1613,                     /* -fopt-info- */
  OPT_foptimize_crc = 1614,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1615, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1616,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1617,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1618, */          /* -foptional-diags */
  OPT_fpack_derived = 1619,                  /* -fpack-derived */
  OPT_fpack_struct = 1620,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1621,                  /* -fpack-struct= */
  OPT_fpad_source = 1622,                    /* -fpad-source */
  OPT_fpartial_inlining = 1623,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1624,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1625,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1626,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1627,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1628,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1629,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1630,                    /* -fpeel-loops */
  OPT_fpeephole = 1631,                      /* -fpeephole */
  OPT_fpeephole2 = 1632,                     /* -fpeephole2 */
  OPT_fpermissive = 1633,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1634,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1635,                           /* -fpic */
  OPT_fpie = 1636,                           /* -fpie */
  OPT_fpim = 1637,                           /* -fpim */
  OPT_fpim2 = 1638,                          /* -fpim2 */
  OPT_fpim3 = 1639,                          /* -fpim3 */
  OPT_fpim4 = 1640,                          /* -fpim4 */
  OPT_fplan9_extensions = 1641,              /* -fplan9-extensions */
  OPT_fplt = 1642,                           /* -fplt */
  OPT_fplugin_arg_ = 1643,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1644,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1645,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1646,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1647,                /* -fpostconditions */
  OPT_fpre_include_ = 1648,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1649,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1650,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1651,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1652,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1653,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1654,              /* -fpretty-templates */
  OPT_fpreview_all = 1655,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1656,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1657,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1658,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1659,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1660,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1661,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1662,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1663,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1664,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1665,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1666,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1667,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1668,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1669,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1670,           /* -fprintf-return-value */
  OPT_fprofile = 1671,                       /* -fprofile */
  OPT_fprofile_abs_path = 1672,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1673,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1674,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1675,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1676,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1677,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1678,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1679,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1680,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1681,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1682,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1683,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1684,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1685,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1686,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1687,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1688,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1689,               /* -fprofile-update= */
  OPT_fprofile_use = 1690,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1691,                  /* -fprofile-use= */
  OPT_fprofile_values = 1692,                /* -fprofile-values */
  OPT_fprotect_parens = 1693,                /* -fprotect-parens */
  OPT_fpthread = 1694,                       /* -fpthread */
  OPT_fq = 1695,                             /* -fq */
  OPT_frandom_seed = 1696,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1697,                  /* -frandom-seed= */
  OPT_frange = 1698,                         /* -frange */
  OPT_frange_check = 1699,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1700,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1701,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1702,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1703,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1704,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1705,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1706,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1707,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1708,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1709,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1710,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1711,               /* -frecord-marker=8 */
  OPT_frecursive = 1712,                     /* -frecursive */
  OPT_free = 1713,                           /* -free */
  /* OPT_freg_struct_return = 1714, */       /* -freg-struct-return */
  /* OPT_fregmove = 1715, */                 /* -fregmove */
  OPT_frelease = 1716,                       /* -frelease */
  OPT_frename_registers = 1717,              /* -frename-registers */
  OPT_freorder_blocks = 1718,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1719,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1720,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1721,             /* -freorder-functions */
  OPT_frepack_arrays = 1722,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1723,          /* -freplace-objc-classes */
  OPT_frepo = 1724,                          /* -frepo */
  OPT_freport_bug = 1725,                    /* -freport-bug */
  OPT_frequire_return_statement = 1726,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1727,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1728, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1729,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1730,                   /* -fresolution= */
  OPT_freturn = 1731,                        /* -freturn */
  OPT_frevert_all = 1732,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1733,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1734,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1735,             /* -frevert=intpromote */
  OPT_frounding_math = 1736,                 /* -frounding-math */
  OPT_frtti = 1737,                          /* -frtti */
  OPT_fruntime_modules_ = 1738,              /* -fruntime-modules= */
  OPT_frust_assume_builtin_offset_of = 1739, /* -frust-assume-builtin-offset-of */
  OPT_frust_borrowcheck = 1740,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1741,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1742,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1743,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1744,                   /* -frust-crate= */
  OPT_frust_debug = 1745,                    /* -frust-debug */
  OPT_frust_dump_ = 1746,                    /* -frust-dump- */
  OPT_frust_edition_ = 1747,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1748,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1749,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1750,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1751,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1752,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1753,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1754,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1755,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1756,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1757,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1758,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1759,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1760,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1761,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1762,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1763,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1764, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1765,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1766,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1767,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1768,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1769,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1770,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1771,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1772,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1773, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1774,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1775,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1776,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1777,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1778,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1779,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1780,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1781,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1782,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1783,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1784,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1785,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1786,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1787,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1788,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1789,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1790, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1791,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1792,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1793,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1794,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1795,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1796,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1797,               /* -fsection-anchors */
  /* OPT_fsee = 1798, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1799,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1800,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1801,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1802,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1803,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1804,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1805,        /* -fsemantic-interposition */
  OPT_fset_stack_executable = 1806,          /* -fset-stack-executable */
  OPT_fshared = 1807,                        /* -fshared */
  OPT_fshort_enums = 1808,                   /* -fshort-enums */
  OPT_fshort_wchar = 1809,                   /* -fshort-wchar */
  OPT_fshow_column = 1810,                   /* -fshow-column */
  OPT_fshrink_wrap = 1811,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1812,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1813,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1814,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1815,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1816,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1817,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1818,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1819,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1820,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1821,                /* -fsoft-check-all */
  OPT_fsources = 1822,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1823,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1824,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1825,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1826,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1827,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1828,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1829,                      /* -fsquangle */
  OPT_fssa_backprop = 1830,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1831,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1832,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1833,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1834, */             /* -fstack-check */
  OPT_fstack_check_ = 1835,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1836,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1837,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1838,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1839,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1840,               /* -fstack-protector */
  OPT_fstack_protector_all = 1841,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1842,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1843,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1844,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1845,                   /* -fstack-usage */
  OPT_fstatic_call = 1846,                   /* -fstatic-call */
  OPT_fstats = 1847,                         /* -fstats */
  OPT_fstdarg_opt = 1848,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1849,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1850, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1851,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1852,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1853, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1854,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1855,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1856,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1857,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1858, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1859,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1860,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1861,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1862,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1863,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1864,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1865,                  /* -fstrub=strict */
  OPT_fswig = 1866,                          /* -fswig */
  OPT_fswitch_errors = 1867,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1868,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1869,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1870,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1871, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1872,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1873, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1874,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1875, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1876,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1877,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1878,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1879,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1880,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1881,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1882,                   /* -ftime-report */
  OPT_ftime_report_details = 1883,           /* -ftime-report-details */
  OPT_ftls_model_ = 1884,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1885,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1886,                   /* -ftrace-debug */
  OPT_ftracer = 1887,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1888,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1889,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1890,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1891,                   /* -ftrampolines */
  OPT_ftransition_all = 1892,                /* -ftransition=all */
  OPT_ftransition_field = 1893,              /* -ftransition=field */
  OPT_ftransition_in = 1894,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1895,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1896,          /* -ftransition=templates */
  OPT_ftransition_tls = 1897,                /* -ftransition=tls */
  OPT_ftrapping_math = 1898,                 /* -ftrapping-math */
  OPT_ftrapv = 1899,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1900,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1901,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1902,                      /* -ftree-ccp */
  OPT_ftree_ch = 1903,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1904, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1905,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1906,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1907, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1908,                   /* -ftree-cselim */
  OPT_ftree_dce = 1909,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1910,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1911,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1912,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1913,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1914, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1915,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1916,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1917, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1918,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1919,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1920, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1921,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1922,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1923,                      /* -ftree-lrs */
  /* OPT_ftree_parallelize_loops = 1924, */  /* -ftree-parallelize-loops */
  OPT_ftree_parallelize_loops_ = 1925,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1926,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1927,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1928,                      /* -ftree-pre */
  OPT_ftree_pta = 1929,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1930,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1931, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1932,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1933,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1934,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1935,                     /* -ftree-slsr */
  OPT_ftree_sra = 1936,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1937, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1938, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1939,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1940,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1941,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1942, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1943,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1944, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1945,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1946,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1947,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1948,         /* -funconstrained-commons */
  OPT_funderscoring = 1949,                  /* -funderscoring */
  OPT_funit_at_a_time = 1950,                /* -funit-at-a-time */
  OPT_funittest = 1951,                      /* -funittest */
  OPT_funreachable_traps = 1952,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1953,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1954,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1955,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1956, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1957,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1958,                      /* -funsigned */
  OPT_funsigned_bitfields = 1959,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1960,                 /* -funsigned-char */
  OPT_funswitch_loops = 1961,                /* -funswitch-loops */
  OPT_funwind_tables = 1962,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1963,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1964,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1965,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1966,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1967,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1968,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1969,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1970,                     /* -fuse-list= */
  OPT_fvar_tracking = 1971,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1972,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1973,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1974,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1975,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1976, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1977,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1978,                   /* -fverbose-asm */
  /* OPT_fversion = 1979, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1980,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1981,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1982,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1983,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1984,                   /* -fvisibility= */
  OPT_fvpt = 1985,                           /* -fvpt */
  OPT_fvtable_gc = 1986,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1987,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1988,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1989,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1990,                     /* -fvtv-debug */
  OPT_fweak = 1991,                          /* -fweak */
  OPT_fweak_templates = 1992,                /* -fweak-templates */
  OPT_fweb = 1993,                           /* -fweb */
  /* OPT_fwhole_file = 1994, */              /* -fwhole-file */
  OPT_fwhole_program = 1995,                 /* -fwhole-program */
  OPT_fwholediv = 1996,                      /* -fwholediv */
  OPT_fwholevalue = 1997,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1998,            /* -fwide-exec-charset= */
  OPT_fwideset = 1999,                       /* -fwideset */
  OPT_fworking_directory = 2000,             /* -fworking-directory */
  OPT_fwpa = 2001,                           /* -fwpa */
  OPT_fwpa_ = 2002,                          /* -fwpa= */
  OPT_fwrapv = 2003,                         /* -fwrapv */
  OPT_fwrapv_pointer = 2004,                 /* -fwrapv-pointer */
  OPT_fwritable_relocated_rdata = 2005,      /* -fwritable-relocated-rdata */
  OPT_fxref = 2006,                          /* -fxref */
  OPT_fyacc_debug = 2007,                    /* -fyacc-debug */
  /* OPT_fzee = 2008, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 2009,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 2010,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 2011,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 2012,                     /* -fzero-link */
  OPT_g = 2013,                              /* -g */
  OPT_gant = 2014,                           /* -gant */
  OPT_gas_loc_support = 2015,                /* -gas-loc-support */
  OPT_gas_locview_support = 2016,            /* -gas-locview-support */
  OPT_gbtf = 2017,                           /* -gbtf */
  OPT_gcodeview = 2018,                      /* -gcodeview */
  OPT_gcoff = 2019,                          /* -gcoff */
  OPT_gcoff1 = 2020,                         /* -gcoff1 */
  OPT_gcoff2 = 2021,                         /* -gcoff2 */
  OPT_gcoff3 = 2022,                         /* -gcoff3 */
  OPT_gcolumn_info = 2023,                   /* -gcolumn-info */
  OPT_gctf = 2024,                           /* -gctf */
  OPT_gdescribe_dies = 2025,                 /* -gdescribe-dies */
  OPT_gdwarf = 2026,                         /* -gdwarf */
  OPT_gdwarf_ = 2027,                        /* -gdwarf- */
  OPT_gdwarf32 = 2028,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2029,                       /* -gdwarf64 */
  OPT_gen_decls = 2030,                      /* -gen-decls */
  OPT_ggdb = 2031,                           /* -ggdb */
  OPT_ggnu_pubnames = 2032,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2033,                   /* -gimple-stats */
  OPT_ginline_points = 2034,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2035, /* -ginternal-reset-location-views */
  OPT_gnat = 2036,                           /* -gnat */
  OPT_gnatO = 2037,                          /* -gnatO */
  OPT_gno_ = 2038,                           /* -gno- */
  OPT_gno_pubnames = 2039,                   /* -gno-pubnames */
  OPT_gprune_btf = 2040,                     /* -gprune-btf */
  OPT_gpubnames = 2041,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2042,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2043,                   /* -gsplit-dwarf */
  OPT_gstabs = 2044,                         /* -gstabs */
  OPT_gstabs_ = 2045,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2046,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2047,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2048,                        /* -gtoggle */
  OPT_gvariable_location_views = 2049,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2050,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2051,                           /* -gvms */
  OPT_gxcoff = 2052,                         /* -gxcoff */
  OPT_gxcoff_ = 2053,                        /* -gxcoff+ */
  OPT_gz = 2054,                             /* -gz */
  OPT_gz_ = 2055,                            /* -gz= */
  OPT_h = 2056,                              /* -h */
  OPT_help = 2057,                           /* -help */
  OPT_idirafter = 2058,                      /* -idirafter */
  OPT_imacros = 2059,                        /* -imacros */
  OPT_imultiarch = 2060,                     /* -imultiarch */
  OPT_imultilib = 2061,                      /* -imultilib */
  OPT_include = 2062,                        /* -include */
  OPT_iplugindir_ = 2063,                    /* -iplugindir= */
  OPT_iprefix = 2064,                        /* -iprefix */
  OPT_iquote = 2065,                         /* -iquote */
  OPT_isysroot = 2066,                       /* -isysroot */
  OPT_isystem = 2067,                        /* -isystem */
  OPT_iwithprefix = 2068,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2069,              /* -iwithprefixbefore */
  OPT_k8 = 2070,                             /* -k8 */
  OPT_l = 2071,                              /* -l */
  OPT_lang_asm = 2072,                       /* -lang-asm */
  OPT_list = 2073,                           /* -list */
  OPT_m128bit_long_double = 2074,            /* -m128bit-long-double */
  OPT_m16 = 2075,                            /* -m16 */
  OPT_m32 = 2076,                            /* -m32 */
  OPT_m3dnow = 2077,                         /* -m3dnow */
  OPT_m3dnowa = 2078,                        /* -m3dnowa */
  OPT_m64 = 2079,                            /* -m64 */
  OPT_m80387 = 2080,                         /* -m80387 */
  OPT_m8bit_idiv = 2081,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 2082,             /* -m96bit-long-double */
  OPT_mabi_ = 2083,                          /* -mabi= */
  OPT_mabm = 2084,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 2085,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 2086,                 /* -maddress-mode= */
  OPT_madx = 2087,                           /* -madx */
  OPT_maes = 2088,                           /* -maes */
  OPT_main = 2089,                           /* -main */
  OPT_main_ = 2090,                          /* -main= */
  OPT_malign_data_ = 2091,                   /* -malign-data= */
  OPT_malign_double = 2092,                  /* -malign-double */
  OPT_malign_functions_ = 2093,              /* -malign-functions= */
  OPT_malign_jumps_ = 2094,                  /* -malign-jumps= */
  OPT_malign_loops_ = 2095,                  /* -malign-loops= */
  OPT_malign_stringops = 2096,               /* -malign-stringops */
  OPT_mamx_avx512 = 2097,                    /* -mamx-avx512 */
  OPT_mamx_bf16 = 2098,                      /* -mamx-bf16 */
  OPT_mamx_complex = 2099,                   /* -mamx-complex */
  OPT_mamx_fp16 = 2100,                      /* -mamx-fp16 */
  OPT_mamx_fp8 = 2101,                       /* -mamx-fp8 */
  OPT_mamx_int8 = 2102,                      /* -mamx-int8 */
  OPT_mamx_movrs = 2103,                     /* -mamx-movrs */
  OPT_mamx_tf32 = 2104,                      /* -mamx-tf32 */
  OPT_mamx_tile = 2105,                      /* -mamx-tile */
  OPT_mapx_features_ = 2106,                 /* -mapx-features= */
  OPT_mapx_inline_asm_use_gpr32 = 2107,      /* -mapx-inline-asm-use-gpr32 */
  OPT_mapxf = 2108,                          /* -mapxf */
  OPT_march_ = 2109,                         /* -march= */
  OPT_masm_ = 2110,                          /* -masm= */
  OPT_mavx = 2111,                           /* -mavx */
  OPT_mavx10_1 = 2112,                       /* -mavx10.1 */
  OPT_mavx10_2 = 2113,                       /* -mavx10.2 */
  OPT_mavx2 = 2114,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 2115,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 2116,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bf16 = 2117,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 2118,                  /* -mavx512bitalg */
  OPT_mavx512bw = 2119,                      /* -mavx512bw */
  OPT_mavx512cd = 2120,                      /* -mavx512cd */
  OPT_mavx512dq = 2121,                      /* -mavx512dq */
  OPT_mavx512f = 2122,                       /* -mavx512f */
  OPT_mavx512fp16 = 2123,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 2124,                    /* -mavx512ifma */
  OPT_mavx512vbmi = 2125,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 2126,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 2127,                      /* -mavx512vl */
  OPT_mavx512vnni = 2128,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 2129,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 2130,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 2131,                       /* -mavxifma */
  OPT_mavxneconvert = 2132,                  /* -mavxneconvert */
  OPT_mavxvnni = 2133,                       /* -mavxvnni */
  OPT_mavxvnniint16 = 2134,                  /* -mavxvnniint16 */
  OPT_mavxvnniint8 = 2135,                   /* -mavxvnniint8 */
  OPT_mbmi = 2136,                           /* -mbmi */
  OPT_mbmi2 = 2137,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 2138,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 2139,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 2140,                    /* -mcet-switch */
  OPT_mcld = 2141,                           /* -mcld */
  OPT_mcldemote = 2142,                      /* -mcldemote */
  OPT_mclflushopt = 2143,                    /* -mclflushopt */
  OPT_mclwb = 2144,                          /* -mclwb */
  OPT_mclzero = 2145,                        /* -mclzero */
  OPT_mcmodel_ = 2146,                       /* -mcmodel= */
  OPT_mcmpccxadd = 2147,                     /* -mcmpccxadd */
  OPT_mconsole = 2148,                       /* -mconsole */
  /* OPT_mcpu_ = 2149, */                    /* -mcpu= */
  OPT_mcrc32 = 2150,                         /* -mcrc32 */
  OPT_mcrtdll_ = 2151,                       /* -mcrtdll= */
  OPT_mcx16 = 2152,                          /* -mcx16 */
  OPT_mdaz_ftz = 2153,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 2154,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 2155,            /* -mdispatch-scheduler */
  OPT_mdll = 2156,                           /* -mdll */
  OPT_mdump_tune_features = 2157,            /* -mdump-tune-features */
  OPT_menqcmd = 2158,                        /* -menqcmd */
  OPT_mf16c = 2159,                          /* -mf16c */
  OPT_mfancy_math_387 = 2160,                /* -mfancy-math-387 */
  OPT_mfentry = 2161,                        /* -mfentry */
  OPT_mfentry_name_ = 2162,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2163,               /* -mfentry-section= */
  OPT_mfma = 2164,                           /* -mfma */
  OPT_mfma4 = 2165,                          /* -mfma4 */
  OPT_mforce_drap = 2166,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2167,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2168,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2169,                       /* -mfpmath= */
  OPT_mfsgsbase = 2170,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2171,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2172, */              /* -mfused-madd */
  OPT_mfxsr = 2173,                          /* -mfxsr */
  /* OPT_mgather = 2174, */                  /* -mgather */
  OPT_mgeneral_regs_only = 2175,             /* -mgeneral-regs-only */
  OPT_mgfni = 2176,                          /* -mgfni */
  OPT_mhard_float = 2177,                    /* -mhard-float */
  OPT_mharden_sls_ = 2178,                   /* -mharden-sls= */
  OPT_mhle = 2179,                           /* -mhle */
  OPT_mhreset = 2180,                        /* -mhreset */
  OPT_miamcu = 2181,                         /* -miamcu */
  OPT_mieee_fp = 2182,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2183,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2184,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2185,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2186,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2187,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2188,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2189,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2190, */            /* -mintel-syntax */
  OPT_mkl = 2191,                            /* -mkl */
  OPT_mlam_ = 2192,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2193,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2194,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2195,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2196,                /* -mlong-double-80 */
  OPT_mlwp = 2197,                           /* -mlwp */
  OPT_mlzcnt = 2198,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2199,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2200,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2201,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2202,                  /* -mmitigate-rop */
  OPT_mmmx = 2203,                           /* -mmmx */
  OPT_mmovbe = 2204,                         /* -mmovbe */
  OPT_mmovdir64b = 2205,                     /* -mmovdir64b */
  OPT_mmovdiri = 2206,                       /* -mmovdiri */
  OPT_mmove_max_ = 2207,                     /* -mmove-max= */
  OPT_mmovrs = 2208,                         /* -mmovrs */
  OPT_mmpx = 2209,                           /* -mmpx */
  OPT_mms_bitfields = 2210,                  /* -mms-bitfields */
  OPT_mmwait = 2211,                         /* -mmwait */
  OPT_mmwaitx = 2212,                        /* -mmwaitx */
  OPT_mneeded = 2213,                        /* -mneeded */
  OPT_mno_align_stringops = 2214,            /* -mno-align-stringops */
  OPT_mno_default = 2215,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2216,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2217,                  /* -mno-push-args */
  OPT_mno_red_zone = 2218,                   /* -mno-red-zone */
  OPT_mnop_fun_dllimport = 2219,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 2220,                    /* -mnop-mcount */
  OPT_mnoreturn_no_callee_saved_registers = 2221,/* -mnoreturn-no-callee-saved-registers */
  OPT_momit_leaf_frame_pointer = 2222,       /* -momit-leaf-frame-pointer */
  OPT_mpartial_vector_fp_math = 2223,        /* -mpartial-vector-fp-math */
  OPT_mpc32 = 2224,                          /* -mpc32 */
  OPT_mpc64 = 2225,                          /* -mpc64 */
  OPT_mpc80 = 2226,                          /* -mpc80 */
  OPT_mpclmul = 2227,                        /* -mpclmul */
  OPT_mpcommit = 2228,                       /* -mpcommit */
  OPT_mpconfig = 2229,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 2230,            /* -mpe-aligned-commons */
  OPT_mpku = 2231,                           /* -mpku */
  OPT_mpopcnt = 2232,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2233, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2234,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2235,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2236,                     /* -mprefetchi */
  OPT_mprfchw = 2237,                        /* -mprfchw */
  OPT_mptwrite = 2238,                       /* -mptwrite */
  OPT_mpush_args = 2239,                     /* -mpush-args */
  OPT_mraoint = 2240,                        /* -mraoint */
  OPT_mrdpid = 2241,                         /* -mrdpid */
  OPT_mrdrnd = 2242,                         /* -mrdrnd */
  OPT_mrdseed = 2243,                        /* -mrdseed */
  OPT_mrecip = 2244,                         /* -mrecip */
  OPT_mrecip_ = 2245,                        /* -mrecip= */
  OPT_mrecord_mcount = 2246,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2247,                 /* -mrecord-return */
  OPT_mred_zone = 2248,                      /* -mred-zone */
  OPT_mregparm_ = 2249,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2250,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2251,                           /* -mrtd */
  OPT_mrtm = 2252,                           /* -mrtm */
  OPT_msahf = 2253,                          /* -msahf */
  /* OPT_mscatter = 2254, */                 /* -mscatter */
  OPT_mserialize = 2255,                     /* -mserialize */
  OPT_msgx = 2256,                           /* -msgx */
  OPT_msha = 2257,                           /* -msha */
  OPT_msha512 = 2258,                        /* -msha512 */
  OPT_mshstk = 2259,                         /* -mshstk */
  OPT_mskip_rax_setup = 2260,                /* -mskip-rax-setup */
  OPT_msm3 = 2261,                           /* -msm3 */
  OPT_msm4 = 2262,                           /* -msm4 */
  OPT_msoft_float = 2263,                    /* -msoft-float */
  OPT_msse = 2264,                           /* -msse */
  OPT_msse2 = 2265,                          /* -msse2 */
  OPT_msse2avx = 2266,                       /* -msse2avx */
  OPT_msse3 = 2267,                          /* -msse3 */
  OPT_msse4 = 2268,                          /* -msse4 */
  OPT_msse4_1 = 2269,                        /* -msse4.1 */
  OPT_msse4_2 = 2270,                        /* -msse4.2 */
  OPT_msse4a = 2271,                         /* -msse4a */
  /* OPT_msse5 = 2272, */                    /* -msse5 */
  OPT_msseregparm = 2273,                    /* -msseregparm */
  OPT_mssse3 = 2274,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2275,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2276, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2277,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2278, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2279,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2280,                  /* -mstackrealign */
  OPT_mstore_max_ = 2281,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2282,            /* -mstringop-strategy= */
  OPT_mstv = 2283,                           /* -mstv */
  OPT_mtbm = 2284,                           /* -mtbm */
  OPT_mthreads = 2285,                       /* -mthreads */
  OPT_mtls_dialect_ = 2286,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2287,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2288,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2289,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2290,                         /* -mtune= */
  OPT_muintr = 2291,                         /* -muintr */
  OPT_municode = 2292,                       /* -municode */
  OPT_munroll_only_small_loops = 2293,       /* -munroll-only-small-loops */
  OPT_muse_libstdc_wrappers = 2294,          /* -muse-libstdc-wrappers */
  OPT_musermsr = 2295,                       /* -musermsr */
  OPT_mvaes = 2296,                          /* -mvaes */
  OPT_mveclibabi_ = 2297,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2298,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2299,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2300,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2301,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2302,                      /* -mwbnoinvd */
  OPT_mwidekl = 2303,                        /* -mwidekl */
  OPT_mwin32 = 2304,                         /* -mwin32 */
  OPT_mwindows = 2305,                       /* -mwindows */
  OPT_mx32 = 2306,                           /* -mx32 */
  OPT_mxop = 2307,                           /* -mxop */
  OPT_mxsave = 2308,                         /* -mxsave */
  OPT_mxsavec = 2309,                        /* -mxsavec */
  OPT_mxsaveopt = 2310,                      /* -mxsaveopt */
  OPT_mxsaves = 2311,                        /* -mxsaves */
  OPT_n = 2312,                              /* -n */
  OPT_name_sort = 2313,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2314,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2315,              /* -no-integrated-cpp */
  OPT_no_pie = 2316,                         /* -no-pie */
  OPT_no_pthread = 2317,                     /* -no-pthread */
  OPT_nocpp = 2318,                          /* -nocpp */
  OPT_nodefaultlibs = 2319,                  /* -nodefaultlibs */
  OPT_nolibc = 2320,                         /* -nolibc */
  OPT_nomain = 2321,                         /* -nomain */
  OPT_nophoboslib = 2322,                    /* -nophoboslib */
  OPT_nostartfiles = 2323,                   /* -nostartfiles */
  OPT_nostdinc = 2324,                       /* -nostdinc */
  OPT_nostdinc__ = 2325,                     /* -nostdinc++ */
  OPT_nostdlib = 2326,                       /* -nostdlib */
  OPT_nostdlib__ = 2327,                     /* -nostdlib++ */
  OPT_o = 2328,                              /* -o */
  OPT_objects = 2329,                        /* -objects */
  OPT_p = 2330,                              /* -p */
  OPT_pass_exit_codes = 2331,                /* -pass-exit-codes */
  /* OPT_pedantic = 2332, */                 /* -pedantic */
  OPT_pedantic_errors = 2333,                /* -pedantic-errors */
  OPT_pg = 2334,                             /* -pg */
  OPT_pie = 2335,                            /* -pie */
  OPT_pipe = 2336,                           /* -pipe */
  OPT_posix = 2337,                          /* -posix */
  OPT_preprocess = 2338,                     /* -preprocess */
  OPT_print_file_name_ = 2339,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2340,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2341,          /* -print-multi-directory */
  OPT_print_multi_lib = 2342,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2343,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2344,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2345,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2346,               /* -print-prog-name= */
  OPT_print_search_dirs = 2347,              /* -print-search-dirs */
  OPT_print_sysroot = 2348,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2349,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2350,                    /* -print-value */
  OPT_pthread = 2351,                        /* -pthread */
  OPT_quiet = 2352,                          /* -quiet */
  OPT_r = 2353,                              /* -r */
  OPT_remap = 2354,                          /* -remap */
  OPT_reverse_sort = 2355,                   /* -reverse-sort */
  OPT_s = 2356,                              /* -s */
  OPT_save_temps = 2357,                     /* -save-temps */
  OPT_save_temps_ = 2358,                    /* -save-temps= */
  OPT_shared = 2359,                         /* -shared */
  OPT_shared_libgcc = 2360,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2361,               /* -shared-libphobos */
  OPT_size_sort = 2362,                      /* -size-sort */
  /* OPT_specs = 2363, */                    /* -specs */
  OPT_specs_ = 2364,                         /* -specs= */
  OPT_static = 2365,                         /* -static */
  OPT_static_libasan = 2366,                 /* -static-libasan */
  OPT_static_libgcc = 2367,                  /* -static-libgcc */
  OPT_static_libgcobol = 2368,               /* -static-libgcobol */
  OPT_static_libgfortran = 2369,             /* -static-libgfortran */
  OPT_static_libgm2 = 2370,                  /* -static-libgm2 */
  OPT_static_libgo = 2371,                   /* -static-libgo */
  OPT_static_libhwasan = 2372,               /* -static-libhwasan */
  OPT_static_liblsan = 2373,                 /* -static-liblsan */
  OPT_static_libmpx = 2374,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2375,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2376,               /* -static-libphobos */
  OPT_static_libquadmath = 2377,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2378,               /* -static-libstdc++ */
  OPT_static_libtsan = 2379,                 /* -static-libtsan */
  OPT_static_libubsan = 2380,                /* -static-libubsan */
  OPT_static_pie = 2381,                     /* -static-pie */
  /* OPT_std_c__03 = 2382, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2383, */                /* -std=c++0x */
  OPT_std_c__11 = 2384,                      /* -std=c++11 */
  OPT_std_c__14 = 2385,                      /* -std=c++14 */
  OPT_std_c__17 = 2386,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2387, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2388, */                /* -std=c++1z */
  OPT_std_c__20 = 2389,                      /* -std=c++20 */
  OPT_std_c__23 = 2390,                      /* -std=c++23 */
  OPT_std_c__26 = 2391,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2392, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2393, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2394, */                /* -std=c++2c */
  OPT_std_c__98 = 2395,                      /* -std=c++98 */
  OPT_std_c11 = 2396,                        /* -std=c11 */
  OPT_std_c17 = 2397,                        /* -std=c17 */
  /* OPT_std_c18 = 2398, */                  /* -std=c18 */
  /* OPT_std_c1x = 2399, */                  /* -std=c1x */
  OPT_std_c23 = 2400,                        /* -std=c23 */
  /* OPT_std_c2x = 2401, */                  /* -std=c2x */
  OPT_std_c2y = 2402,                        /* -std=c2y */
  /* OPT_std_c89 = 2403, */                  /* -std=c89 */
  OPT_std_c90 = 2404,                        /* -std=c90 */
  OPT_std_c99 = 2405,                        /* -std=c99 */
  /* OPT_std_c9x = 2406, */                  /* -std=c9x */
  OPT_std_f2003 = 2407,                      /* -std=f2003 */
  OPT_std_f2008 = 2408,                      /* -std=f2008 */
  OPT_std_f2008ts = 2409,                    /* -std=f2008ts */
  OPT_std_f2018 = 2410,                      /* -std=f2018 */
  OPT_std_f2023 = 2411,                      /* -std=f2023 */
  OPT_std_f202y = 2412,                      /* -std=f202y */
  OPT_std_f95 = 2413,                        /* -std=f95 */
  OPT_std_gnu = 2414,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2415, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2416, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2417,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2418,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2419,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2420, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2421, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2422,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2423,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2424,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2425, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2426, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2427, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2428,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2429,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2430,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2431, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2432, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2433,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2434, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2435,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2436, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2437,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2438,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2439, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2440, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2441,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2442, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2443, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2444, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2445, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2446, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2447, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2448,                     /* -std=legacy */
  OPT_stdlib_ = 2449,                        /* -stdlib= */
  OPT_symbol_ = 2450,                        /* -symbol= */
  OPT_symbolic = 2451,                       /* -symbolic */
  OPT_t = 2452,                              /* -t */
  OPT_time = 2453,                           /* -time */
  OPT_time_ = 2454,                          /* -time= */
  OPT_traditional = 2455,                    /* -traditional */
  OPT_traditional_cpp = 2456,                /* -traditional-cpp */
  OPT_tree_stats = 2457,                     /* -tree-stats */
  OPT_trigraphs = 2458,                      /* -trigraphs */
  OPT_truncate = 2459,                       /* -truncate */
  OPT_type_stats = 2460,                     /* -type-stats */
  OPT_u = 2461,                              /* -u */
  OPT_undef = 2462,                          /* -undef */
  OPT_v = 2463,                              /* -v */
  OPT_version = 2464,                        /* -version */
  OPT_w = 2465,                              /* -w */
  OPT_wrapper = 2466,                        /* -wrapper */
  OPT_x = 2467,                              /* -x */
  OPT_z = 2468,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
