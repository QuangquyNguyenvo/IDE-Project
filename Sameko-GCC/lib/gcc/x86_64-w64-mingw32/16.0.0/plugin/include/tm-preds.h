/* Generated automatically by the program 'R:\winlibs_staging_ucrt64\gcc-16-20251026\build_mingw\gcc\build\genpreds.exe'
...
extern bool const_vec_dup_operand (rtx, machine_mode);
